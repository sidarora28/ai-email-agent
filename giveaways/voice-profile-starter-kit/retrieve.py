...
and returns your top-K most similar past replies from the voice profile.
    ...
    python retrieve.py < data/sample_inbound.txt
    python retrieve.py "can you share the course price?"

Also exposes retrieve_similar(text, k=5) for import by your own code.
...
# never touch the network. This also satisfies "works fully offline".
