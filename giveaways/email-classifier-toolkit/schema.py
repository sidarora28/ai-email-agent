...
feeding garbage into downstream tools.
"""
...
class Classification(BaseModel):
    ...
    category: str = Field(..., description="One of the categories in your taxonomy yaml")
    ...
    # carried through from the source email so downstream tools can render it
